...
var x = setInterval(function() {
  ...
  document.getElementById("demo").innerHTML = days + "<span style='color:#9dddf9ff'>...</span>" +  hours + "<span style='color:#9dddf9ff'>...</span>"
  + minutes + "<span style='color:#9dddf9ff'>...</span>"  + seconds;
